...
public class Plantation {
    ...
    public Plantation(Feve typeFeve, int parcelles, int age) {
        ...
        switch (typeFeve) {
            case F_BQ:
                ...
                this.salaire_employe = 50; 
                this.salaire_employe_initial = 50;
    ...
    /**
     * Avance l'âge de la plantation d'un step et renvoie la quantité produite en
     * tonnes.
     */
    ...
    /**
     * Vérifie si la plantation doit être vendue (morte depuis trop longtemps sans
     * replantation)
     */
